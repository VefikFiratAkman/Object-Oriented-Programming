...
int ConnectFourAbstract::currentHeight()const{
    return height;
}

int ConnectFourAbstract::currentWidth()const{
    return width;
}
...
void ConnectFourAbstract::play(char position,int players) {
...
int ConnectFourAbstract::endGame()const{
...
int ConnectFourAbstract::bestGame(ConnectFourAbstract & a,ConnectFourAbstract & b,ConnectFourAbstract & c,ConnectFourAbstract & d)const{
...
int ConnectFourAbstract::LegalMove( int cord)const{
...
int ConnectFourAbstract::aiLegalMove( int cord)const{
...
int ConnectFourAbstract::boardFull() const{
...
int ConnectFourAbstract::checkWinVertical(){
...
int ConnectFourAbstract::checkWinHorizontal(){
...
int ConnectFourAbstract::checkWinDiagonal1(){
...
int ConnectFourAbstract::checkWinDiagonal2(){
...
int ConnectFourAbstract::aiSelect(){
...
int ConnectFourAbstract::aiPlayerVerticalStopper( int & cord){
...
int ConnectFourAbstract::aiPlayerHorizontalStopper(int & cord){
...
int ConnectFourAbstract::aiPlayerDiagonal1Stopper( int & cord){
...
int ConnectFourAbstract::aiPlayerDiagonal2Stopper( int & cord){
...
int ConnectFourAbstract::aiWinVertical( int & cord){
...
int ConnectFourAbstract::aiWinHorizontal( int & cord){
...
int ConnectFourAbstract::aiWinDiagonal1( int & cord){
...
int ConnectFourAbstract::aiWinDiagonal2( int & cord){
...
int ConnectFourAbstract::save(int players,char mod, string filename)const{
...
int ConnectFourAbstract::load(int & players,char & mod,string filename){
...
int ConnectFourAbstract::readSet(string filename){
...
int ConnectFourAbstract::maxcolumn(string filename2){
...
bool ConnectFourAbstract::operator ==(const ConnectFourAbstract & other) const{
         ...
         iki ConnectFourAbstract tipinde objeyi karsilastirilmasini saglar. */
...
istream & operator >>(istream & in, Cell & obje){
	/*Bu fonksiyon operator overloadingtir.Ve >> operatorunun
...
ostream & operator <<(ostream & out, Cell & obje){
    /*Bu fonksiyon operator overloadingtir.Ve >> operatorunun
    Cell tipinde ki objesinin degerlerinin >>ile kolayca
...
/* ---HW04 Fucntion Ama Tanimlayip icini yazmamisim.Hw05 te yazdim---- */
...
/* -------------- Start Of HW05 Fucntions --------- */
void ConnectFourAbstract::createNewTable(){
        /* Row Ve Column Alınarak Constuctorda
        olusan 5x5lik oyun degistirilir.  */
        ...
        while (true) {
            ...
            cin >> height;
                if(!cin) {
                    cin.clear();
                    cin.ignore();
                    cerr << "Error: Value is not valid \n";
                }
                else if(height < 4){
                    cerr << "Error: Value must bigger than 4 \n";
                }
                else{
                    break;
                }
